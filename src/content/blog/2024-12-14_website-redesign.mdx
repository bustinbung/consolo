...
I made extensive use of Figma's auto layout to simulate CSS flexboxes, as I knew that's the framework I wanted to use for the site.

<iframe style="border: 1px solid rgba(0, 0, 0, 0.1);" width="800" height="450" src="https://embed.figma.com/design/gQ5JLAJQ83qM1OYkghgidg/v6.1-redesign?node-id=0-1&embed-host=share" allowfullscreen></iframe>
